...
function dc_sp_menu_spam() {
	...
	<div class="wrap">
		...
		echo '<p>Spam Protection has blocked ' . $dc_sp_total_items . ' comments.</p>';
		...
		$pag->set_target_page( "admin.php?page=menu_spam" );//Set target page
